    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('caisse-edit-valid') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-xl" value="{{ old('nom') }}" id="nom" name="name_caisse" required placeholder="Nom *" autocomplete="0" />
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('caisse-del-valid') }}">
                {{ csrf_field() }}

                <input type="hidden" class="" name="id" id="id">
                <p>Voulez-vous supprimer cette caisse ?</p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('caisse-create-valid') }}">

                {{ csrf_field() }}

                <div class="form-group">
                  <label for="name_caisse">Nom de la caisse </label>
                  <input type="text" class="form-control form-control-xl" value="{{ old('name_caisse') }}" id="name_caisse" name="name_caisse" required placeholder="Nom de la caisse *" autocomplete="0" />
                </div>
