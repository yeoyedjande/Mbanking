...
<section class="section">
    ...
    <div class="row mt-5">
      ...
      <div class="col-md-7">
        <h3>Solde Principal: {{ number_format($solde_principal->debiteur, 0, 2, ' ') }} BIF</h3>
      </div>

      <div class="col-md-5 d-flex justify-content-end">
          <a href="#collapseExample" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseExample" class="btn btn-primary btn-lg">
               Recharger une caisse
          </a>
      </div>

    </div>

    <div class="row mt-5 collapse" id="collapseExample">
        <div class="col-md-12">
          <div class="card">
            <div class="card-content">
              <div class="card-body">
                <h4 class="card-title">Rechargement de caisse</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <select class="form-control form-control-xl" id="" name="guichetier" required>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control form-control-xl" name="montant" id="amount" min="1" required>
                              </div>
                            </div>

                            <div class="col-md-12">
                              <div class="form-group">
                                  <button type="submit" class="btn btn-dark btn-lg">Recharger</button>
                              </div>
                            </div>
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-header">
              <h4>Liste des caisses rechargées</h4>
            </div>
            <div class="card-content text-center">
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        @if($m->verify === 'ferme')
                        <button class="btn btn-dark btn-xs">Caisse fermée</button>
                        @endif

                        @if($m->verify === 'cancel')
                        <button class="btn btn-danger btn-xs">Caisse annulée</button>
                        @endif

                        @if($m->verify === 'yes')
                        <button class="btn btn-success btn-xs">Caisse ouvert</button>
                        @endif

                        @if($m->verify === 'no')
                        <button class="btn btn-info btn-xs">En attente de validation</button>
                        <button type="button" data-id = "{{ $m->id }}" data-name = "{{ $m->name }}" data-nom = "{{ $m->nom }}" data-prenom = "{{ $m->prenom }}" data-solde_initial = "{{ $m->solde_initial }}" data-solde_final = "{{ $m->solde_final }}" data-bs-toggle="modal" data-bs-target="#annulation_caisse" class="btn btn-danger btn-xs">Annuler la caisse</button>
                ...
                <div class="alert alert-info">
                  ...
                  <p>Vous n'avez pas encore ouvert de caisse a cette date !</p>
                </div>
                @endif
              </div>
            </div>
