  ...
  <section class="row">
      ...
      <div class="card">
          ...
          <div class="card-body">
              ...
              <form action="{{ route('caisse-reajuster-valide') }}" method="POST">

                {{ csrf_field() }}

                <input type="hidden" value="{{ $mvmt->id }}" name="mvmt_id">

                <input type="hidden" value="{{ $mvmt->solde_fermeture }}" name="solde_fermeture">
                  ...
                  <div class="row">
                    <div class="col-md-6 mt-5">
                      ...
                      <div class="form-group">
                          ...
                          <button type="submit" class="btn btn-danger btn-lg">Continuer ></button>
