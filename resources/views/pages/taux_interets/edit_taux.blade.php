    ...
    <div class="col-md-4 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" action="{{ route('taux-interet-edit') }}" method="POST">

            {{ csrf_field() }}
            <input type="hidden" name="taux_id" value="{{ $t->id }}">
            <div class="form-group">
              <label for="taux">Saisie le taux en pourcentage (%) * </label>
              <input type="number" class="form-control" value="{{ $t->taux*100 }}" id="taux" name="taux" required autocomplete="0" />
            </div>
