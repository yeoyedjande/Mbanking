    ...
    @endif
    	...
    	<div class="row">
		    ...
		    <div class="col-md-7 grid-margin stretch-card">
		      ...
		      <div class="card">
		        <div class="card-body">
		          <h4 class="card-title mb-4">Faire un versementggg</h4>
		            ...
		            <div class="row">
		            	...
		            	<div class="col-md-12">
										<div class="form-group">
				              <label for="amount">Montant du versement * </label>
				              <input type="number" id="amount" min="1" class="form-control form-control-lg" name="amount" required>
 									...
 									<div class="col-md-12">
										<div class="form-group">
				              <button type="button" data-bs-toggle="modal" data-bs-target="#addVersement" class="btn btn-primary btn-lg me-2"> <i class="mdi mdi-arrow-down"></i> &nbsp;&nbsp; Effectuer le versement</button>
				            </div>
		            	</div>
								</div>
		  ...
		  <div class="modal-dialog modal-md" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel">Réviser le versement</h5>
		        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
		          <span aria-hidden="true">&times;</span>
		        </button>
		      </div>

		      <form class="forms-sample" action="{{ route('versement-new-valid') }}" method="POST">
		      <div class="modal-body">
		        		...
		        		<div id="dragula-right" class="py-2 content">
                  ...
                  <div class="rounded border mb-2">
                      <div class="card-body p-3">
                        <div class="media">
                          <i class="mdi mdi-money icon-sm align-self-center me-3"></i>
                          <div class="media-body">
                            <h6 class="mb-1">Montant à verser</h6>
                  ...
                  <div class="rounded border mb-2">
                      <div class="card-body p-3">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <h6 class="mb-1">Date du versement</h6>
                            <p class="mb-0 text-muted">
                            	<?= date('d/m/Y'); ?>
                            </p>
                          </div>
...
<script type="text/javascript">
		...
		$(document).ready(function() {
		        ...
		        if ( Number(amount) > 2000000 ) {
		        	...
		        	$('.modal-footer').html('<button type="submit" class="btn btn-danger">Demander une autorisation</button><button type="button" class="btn btn-light" data-bs-dismiss="modal">Retour</button>');
		        	...
		        	$('.modal-footer').html('<button type="submit" class="btn btn-success">Confirmer le versement</button><button type="button" class="btn btn-light" data-bs-dismiss="modal">Retour</button>');
		        }
