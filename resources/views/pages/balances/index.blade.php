...
@section('title', 'Personnalisation de la balance')
	        ...
	        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
	          ...
	          <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active" aria-current="page">
	              ...
	              Personnalisation de la balance
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('balance-date-intervalle') }}">
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('balance-periode') }}">
