      	...
      	<div class="col-md-6">
      		...
      		<div class="card">
		        ...
		        <div class="card-body">
		          	...
		          	<form class="" method="POST" enctype='multipart/form-data' action="{{ route('seuil-edit-versement-valid') }}">
				              ...
				              <input type="text" value="{{ $seuil->montant_limite }}" id="amount" min="1" class="form-control form-control-xl remplir" name="amount" autocomplete="off" required>
				            </div>
      	...
      	<div class="col-md-6">
			...
			<div class="card">
		        ...
		        <div class="card-body">
		        	...
		        	<form class="" method="POST" enctype='multipart/form-data' action="{{ route('seuil-valid-retrait') }}">
		          			...
		          			<div class="form-group">
		          			  <label style="">Montant limite *</label>
				              <input type="text" id="amount" value="" min="1" class="form-control form-control-xl remplir" name="amount" autocomplete="off" required>
				            </div>
