...
<script>
  $(document).ready(function() {
    ...
    function updateRecapFields() {
        // Récupérez les valeurs des champs de chaque étape (page 1)
        ...
        var langueCorrespondance = $('#lang').val();
        ...
        var email = $('#email').val();
        var nombreMembres = $('#membres').val();
        var nombreHommeGroup = $('#nombre_homme_group').val();
        var nombreFemmeGroup = $('#nombre_femme_group').val();
        ...
        // Ajoutez d'autres champs de la première étape ici
        $('#recap_langue_correspondance').text(langueCorrespondance);
        ...
        $('#recap_numero_telephone').text(telephone);
        $('#recap_email').text(email);
        $('#recap_nombre_membres').text(nombreMembres);
        $('#recap_nombre_homme_group').text(nombreHommeGroup);
        $('#recap_nombre_femme_group').text(nombreFemmeGroup);

        // Récupérez les valeurs des champs de la deuxième étape (page 2)
        var secteurActivite = $('#secteur_activite').val();
        var nombreBanques = $('#nombre_banques').val();
        var dateAgrement = $('#date_agrement').val();
        ...
        $('#recap_date_agrement').text(dateAgrement);
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3 style="text-transform: uppercase;">Ouverture groupe formelle</h3>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" id="form-pars" method="POST" action="{{route('InsertionGroupeFormelle')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}

                                <input type="hidden" value="{{ $etat_juridique->id }}" name="id_groupe_formelle">
                                ...
                                <div class="form-section current">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-xl" type="number" name="ancien_numero_client" data-parsley-group="block1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly value="<?= date('d/m/Y'); ?>" id="date" class="form-control form-control-xl" name="date_ouverture_compte" required data-parsley-group="block1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="membres" class="form-label">Nombre de membres du groupe <span class="text-danger"> *</span></label>
                                                    <input type="number" id="membres" class="form-control form-control-xl" name="nombre_membres" required data-parsley-group="block1">
                                              </div>
                                            </div>

                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="nombre_homme_group" class="form-label">Nombre d'homme du groupe</label>
                                                    <input type="number" id="nombre_homme_group" class="form-control form-control-xl" name="nombre_homme_group">
                                              </div>
                                            </div>

                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="nombre_femme_group" class="form-label">Nombre de femme du groupe</label>
                                                    <input type="number" id="nombre_femme_group" class="form-control form-control-xl" name="nombre_femme_group">
                                              </div>
                                            </div>
                                    ...
                                    <div class="form-section">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                  <label for="date_agrement" class="form-label">Date d'agrément du groupe informel</label>
                                                    <input type="date" id="date_agrement" class="form-control form-control-xl" name="date_agrement">
                                              </div>
                                            </div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="recap-container">
                                            <div class="recap-column">
                                                ...
                                                <p><strong>Nombre de membres du groupe:</strong> <span id="recap_nombre_membres"></span></p>
                                                <p><strong>Nombre d'homme du groupe:</strong> <span id="recap_nombre_homme_group"></span></p>
                                                <p><strong>Nombre de femme du groupe:</strong> <span id="recap_nombre_femme_group"></span></p>
                                            ...
                                            <div class="recap-column">
                                                ...
                                                <p><strong>Date d'agrément du groupe informel:</strong> <span id="recap_date_agrement"></span></p>
