    ...
    <div class="col-md-4 grid-margin stretch-card">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <h4 class="card-title mb-4">Créer une agence</h4>

          <form class="forms-sample" action="{{ route('agence-create') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-xl" value="{{ old('nom') }}" id="nom" name="nom" required placeholder="Nom agence *" autocomplete="0" />
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-xl" value="{{ old('ville') }}" id="ville" name="ville" required placeholder="Ville agence *" autocomplete="0" />
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-xl" value="{{ old('quartier') }}" id="quartier" name="quartier" required placeholder="Quartier agence *" autocomplete="0" />
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-xl" value="{{ old('tel') }}" id="tel" name="tel" required placeholder="Telephone agence *" autocomplete="0" />
            ...
            <div class="form-group">
              ...
              <textarea class="form-control form-control-xl" id="adresse" rows="5" placeholder="Adresse" name="adresse"></textarea>
