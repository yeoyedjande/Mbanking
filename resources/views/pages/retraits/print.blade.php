...
<body>
	...
	<table align="" width="300" border="0">
		<tr>
	...
	<table align="center" width="" border="0">
		...
		<?php 
			...
			$frais = DB::table('operations')
			->join('type_frais', 'type_frais.id', '=', 'operations.frais')
			->select('type_frais.name as nom_frais', 'type_frais.montant as montant_frais')
			->Where('operations.ref', $v->ref)
			->first();
		...
		<tr>
			<td width="" align="" style="">
				{{ $frais->nom_frais }} :
			</td>
			<td width="" align="">
				{{ $frais->montant_frais }} BIF
			</td>
		</tr>

		<?php }else{ $montant_frais = 0; } ?>
		<tr>
			<td width="" align="">
				MONTANT TOTAL DEBITÉ:
			</td>
			<td width="" align="">
				<b>{{ number_format($v->montant + $montant_frais, 0, 2, ' ') }} BIF</b>
			</td>
		</tr>
