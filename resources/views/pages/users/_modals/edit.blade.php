      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('editUser') }}">
                ...
                <div class="form-group">
                    <label for="date_edit">Date de modification *</label>
                    <input type="date" name="date_edit" class="form-control form-control-xl" value="{{ now()->format('Y-m-d') }}" id="date_edit" readonly>
                </div>

                <div class="form-group">
                    <label for="user_edit">Utilisateur modificateur *</label>
                    <input type="text" name="user_edit" required class="form-control form-control-xl" id="user_edit" value="{{ Auth::user()->nom }} {{ Auth::user()->prenom }}" readonly />
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('delUser') }}">
                {{ csrf_field() }}
