        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('role-edit-valid') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nom" name="nom" required placeholder="Nom de la permission *" autocomplete="0" />
                </div>
                <div class="form-group">
                  <label for="groupe">Groupe * </label>
                  <input type="text" style="text-transform: uppercase;" class="form-control" id="groupe" name="groupe" required placeholder="UTILISATEURS *" autocomplete="0" />
                </div>
                <div class="form-group">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('permission-create-valid') }}">
