...
@section('title', 'Liste Des Plafonds')
    ...
    <div class="page-title">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 order-md-1 order-last">
          ...
          <h3 style="text-transform: uppercase;">Liste des plafonds</h3>
      ...
      <div class="card">
          ...
          <div class="card-header">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('plafonds-create') }}" class="btn btn-primary">
              ...
              <table id="order-listing" class="table" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><b>{{ $p->montant_max }}</b></td>

                    <td class="text-center"><b>{{ $p->montant_min }}</b></td>

                    <td class="text-center">

                      <a href="{{ route('plafonds-edit', $p->id) }}" class="btn btn-info">

                        <i class="mdi mdi-pencil"></i> Modifier </a>

                        <button class="btn btn-danger" data-bs-toggle="modal" data-id="{{ $p->id }}" data-bs-target="#delete" title="Supprimer">
              ...
              @else
                  ...
                  <div class="card card-inverse-danger mb-5">
                    ...
                    <div class="card-body">
                      ...
                      <p class="alert alert-info mb-4"> Vous n'avez pas encore défini un plafond !</p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" method="POST" action="{{ route('plafonds-delete') }}">
                {{ csrf_field() }}

                <input type="hidden" class="" name="id" id="id">
                <p>Voulez-vous supprimer cet plafond ?</p>
