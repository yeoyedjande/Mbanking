...
@section('title', 'Commencer à imprimer un relevé')
	...
	<div class="page-heading">
	  ...
	  <div class="row">
	      ...
	      <div class="col-md-6">
	        ...
	        <h3>Commencer à imprimer un relevé</h3>
  ...
  <section class="row">
      ...
      <div class="card">
          ...
          <div class="card-body text-center">
              ...
              <h1 style="font-size: 50px;"><i class="bi bi-file"></i></h1>

              <h2 class="mb-4" style="color: blue;">

                Vous êtes sur le point d'imprimer un relevé, <br>êtes-vous prêt pour commencer ?
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <h2 class="mb-4">Commencer</h2>

            <form class="" method="GET" action="{{ route('releve-search') }}">
