  ...
  <div class="page-title">
    ...
    <section class="section">
        <div class="card">
          ...
          <div class="card-body">
            @if( $demande_attentes->isNotEmpty() )
                ...
                <tbody>
                  ...
                  @php
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('avis-consulting', $d->num_dossier) }}" class="btn btn-primary btn-xs">Donnez votre avis <i class="bi bi-arrow-right"></i></a>
                        </td>
