    ...
    <section class="section">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table class="table table-striped" id="">
                <thead>
                  <tr style="text-transform: uppercase;">
                    ...
                    <th class="text-center">Montant Déboursé</th>
                    <th class="text-center">Produit</th>
                    <th class="text-center">Date d'Octroi</th>
                  ...
                  @php
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            {{ number_format($d->montant_octroye, 0, 2, ' ') }} BIF
                        </td>


                        <td class="text-center"><b>{{ number_format($d->montant_debourse, 0, 2, ' ') }} BIF</b></td>
                        <td class="text-center">
                            {{ $d->name }}
                        </td>
                        <td class="text-center">
                          <?= date("d/m/Y", strtotime($d->date_deblocage)); ?>
                        </td>
              ...
              {{ $credits->links('vendor.pagination.custom-pagination') }}
              @else
