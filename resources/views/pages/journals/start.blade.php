...
@section('title', 'Personnalisation du Journal')
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="GET" action="{{ route('journal-search-date-intervalle') }}">
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="GET" action="{{ route('journal-search-periode') }}">
